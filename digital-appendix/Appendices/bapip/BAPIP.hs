...
let files = [(showBSVPackage packageBSV)]
		...
		++ [("ClockTick.pvs", clockTick), ("defined_operators.pvs", definedOperators), ("Time.pvs", timeFile), ("arith_bitwise.pvs", arith_BWFile), ("FIFO.pvs", fifoFile)]
writeFileList files 
